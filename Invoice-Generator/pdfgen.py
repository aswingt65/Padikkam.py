...
def About():
  ...
  pdf.setFont("Courier-Bold",20)
  pdf.drawString(40,700,"Aswin George Thomas")
  pdf.setFont("Courier-Bold",15)
  pdf.drawString(40,650,"Student, ")
  pdf.drawString(40,630,"Computer Science & Engineering,")
  pdf.drawString(40,610,"College of Engineering,")
  pdf.drawString(40,590,"Aranmula.")
  pdf.drawString(40,550,"Contact: aswingt65@gmail.com")
  pdf.save()
